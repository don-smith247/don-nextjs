    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        >Captivating <span className=" text-accent">stories</span> birth magnificent designs.</motion.h2>
          ...
          animate="show"
          exit="hidden">
            5 years ago, i began freelancing as a developer. since then, i've done remote work for agencies, counsulted
             for startups, and collaborated on digital product for and consumer use.  
          </motion.p>
