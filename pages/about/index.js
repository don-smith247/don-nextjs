    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        >Captivating <span className=" text-accent">stories</span> birth magnificent designs.</motion.h2>
          ...
          animate="show"
          exit="hidden">
            5 years ago, I began freelancing as a developer. Since then, I&apos;ve done remote work for agencies, consulted
             for startups, and collaborated on digital products for consumer use.  
          </motion.p>
          <motion.div className=" hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 "
         ...
         exit="hidden">
           ...
           <div className="py-2 xl:py-6 flex flex-col gap-y-2 items-center xl:items-start ">
