      ...
      {testimonialData.map((person, index)=>{
          return (
            <SwiperSlide key={index}>
              <div  className=' text-center flex flex-col items-center md:flex-row gap-x-8 h-full px-16 '>
                 ...
                 <div className=' flex-1 flex-col justify-center before:w-[1px] xl:before:bg-white/20
