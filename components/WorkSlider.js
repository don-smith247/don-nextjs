                ...
                {slide.images.map((image, index)=>{
                  ...
                  key={index}>
                    <div className=' flex items-center justify-center relative overflow-hidden group'>
                      ...
                      <div className=' absolute bottom-0 translate-y-full group-hover:translate-y-[-35px] transition-all duration-300 '>
                        <div className=' flex items-center gap-x-2text-[13px] tracking-[0.15rem] '>
